...
When('I enter email as {string} and password {string}', async function (email, password) {
  this.logger.debug(`Entering email: ${email}`);
  ...
  this.logger.debug('Email and password entered successfully');
});
